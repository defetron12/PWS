...
body {
	...
	width: 100%;
	background: linear-gradient(45deg, #845ec2, #d65db1, #ff6f91, #ff9671, #ffc75f,
		#f9f871);
}
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item active "><a class="nav-link" href="home">Return</a>
					</li>
...
<div class="print">
	...
	<div class="table-wrapper" id="printable-area">
		<table class="fl-table text-left" align="center"
			...
			<tr>
				<td>Salary:</td>
				<td>${employeedetails.empSalary}</td>
			</tr>

			<tr>
				<td>Annual Salary :</td>
				<td>${employeedetails.empSalary*12}</td>
			</tr>

			<tr>
				<td>DA:</td>
				<td>${employeedetails.empSalary*30/100}</td>
			</tr>

			<tr>
				<td>HRA :</td>
				<td>${employeedetails.empSalary*12.5/100}</td>
			</tr>

			<tr>
				<td>PF :</td>
				<td>${employeedetails.empSalary*10/100}</td>
			</tr><tr>
			<td><c:if test="${employeedetails.empSalary<=10000}"></<br>
			    Tax: No Tax
				</c:if> <c:if
					test="${employeedetails.empSalary>10000}&&${ employeedetails.empSalary<100000}">
				Tax: <c:out value="${employeedetails.empSalary*0.10}" />
				</c:if> <c:if test="${employeedetails.empSalary>100000}">
				Tax: <c:out value="${employeedetails.empSalary*0.20}" />
				</c:if></td></tr>
		</table>
	</div>
	</div>
