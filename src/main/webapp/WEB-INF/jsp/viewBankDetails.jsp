...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="table-wrapper">
		<table class="fl-table">
			...
			<c:forEach items="${Banklist}"
				var="employeeDetailsAdmin">
				<tr>
					<td>${employeeDetailsAdmin.bankempId}</td>
					<td>${employeeDetailsAdmin.empName}</td>
					<td>${employeeDetailsAdmin.empEmail}</td>
					<td>${employeeDetailsAdmin.accountNumber}</td>
					<td>${employeeDetailsAdmin.bankName}</td>
					<td>${employeeDetailsAdmin.accountType}</td>
					<td>${employeeDetailsAdmin.accountIfsc}</td>
	...
	<div align="center">
	<a class="text-center btn btn-light" href="home" role="button"> Return</a>
    </div>
