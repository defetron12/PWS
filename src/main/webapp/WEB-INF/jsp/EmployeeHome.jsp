    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="sidebar-container">
        ...
        <ul class="sidebar-navigation">
          ...
          <li>
            <a href="updateBank">
              <i class="fa fa-home" aria-hidden="true"></i> Update Bank Details
            </a>
          </li>
          <li>
            <a href="/employeepayslipview/${empId}">
              <i class="fa fa-tachometer" aria-hidden="true"></i>View Customer Details
            </a>
          </li>
