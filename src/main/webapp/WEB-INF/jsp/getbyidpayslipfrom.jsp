...
<body>
    ...
    <form action="getbyidpayslip" method="post" style="box-shadow:0 8px 32px 0 rgba(31 ,38,135,.37); border-radius: 30px;border-left: 1px solid rgba(255,255,255,.3) ;
    border-top: 1px solid rgba(255,255,255,rgba(255,255,255,.3));">
        <h3>Enter Customer ID</h3>
        
        <label>Customer ID</label>
        <input type="text" name ="empId"  placeholder="Enter Customer ID here">
